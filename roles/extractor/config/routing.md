...
|-------|------|---------|------|
| _Твой домен (напр. Machine Learning)_ | _PACK-my-domain_ | _MD_ | _/c/Users/admin/IWE/PACK-my-domain/pack/my-domain/_ |
...
| Правило (глобальное) | `rule` | `/c/Users/admin/IWE/CLAUDE.md` | Строки |
...
|---------|--------|-------------|
| _Мой бот_ | _DS-IT-systems/my-bot_ | _/c/Users/admin/IWE/DS-IT-systems/my-bot/docs/_ |
