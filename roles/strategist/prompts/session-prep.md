...
- Добавь в WeekPlan секцию `## Weekly Control Sheet (операционный контур недели)` по фиксированному шаблону (ниже в блоке «Формат WeekPlan»), чтобы в каждом новом WeekPlan были одинаковые поля плана/факта/уроков/изменений.
...
## Weekly Control Sheet (операционный контур недели)

### 1) Фокус недели
- Приоритетные контуры (2 из 4): [ ] Диссертация [ ] Деньги [ ] Здоровье [ ] ФиЯ
- Главная гипотеза недели: _
- Ограничение недели (что НЕ делаю): _

### 2) План мини-РП (понедельник, 45 мин)

| Контур | Мини-РП недели (1 шт) | План (что конкретно делаю) | Внешний критерий факта |
|---|---|---|---|
| Диссертация | _ | _ | _ |
| Деньги | _ | _ | _ |
| Здоровье | _ | _ | _ |
...
### 3) Дневной трекинг факта (10 мин в день)

| День | Диссертация | Деньги | Здоровье | ФиЯ | Комментарий (1 строка) |
|---|---|---|---|---|---|
| Пн | план/факт | план/факт | план/факт | план/факт | _ |
| Вт | план/факт | план/факт | план/факт | план/факт | _ |
| Ср | план/факт | план/факт | план/факт | план/факт | _ |
| Чт | план/факт | план/факт | план/факт | план/факт | _ |
| Пт | план/факт | план/факт | план/факт | план/факт | _ |
| Сб | план/факт | план/факт | план/факт | план/факт | _ |
| Вс | план/факт | план/факт | план/факт | план/факт | _ |

### 4) Weekly Review (пт/вс, 45 мин) — формат B.5

#### 4.1 Гипотезы и проверка
| Контур | Гипотеза | Следствие (что должно было случиться) | Факт | Статус |
|---|---|---|---|---|
| _ | _ | _ | _ | поддержано / не поддержано / повторная проверка |

#### 4.2 Уроки недели
- Подтвержденный урок 1: _
- Подтвержденный урок 2: _
- Неподтвержденная связь (не переносить в правила): _

### 5) Изменения правил на следующую неделю (обязательно >=1)

| № | Что меняю (правило/ритуал/ограничение) | Где применяю | Ожидаемый эффект | Горизонт проверки |
|---|---|---|---|---|
| 1 | _ | _ | _ | 1 неделя |
| 2 | _ | _ | _ | 1-2 недели |

### 6) Чек закрытия недели (Definition of Done)

- [ ] Факт минимум по 2 приоритетным контурам
- [ ] Заполнен weekly review (гипотеза -> следствие -> факт)
- [ ] Зафиксировано минимум 1 изменение правила
- [ ] По неприоритетным контурам есть поддерживающий шаг + причина неполного цикла

### 7) Сигналы сбоя (быстрая диагностика)

- [ ] Нет факта 2 недели подряд в приоритетном контуре
- [ ] Повтор одной и той же ошибки без изменения правила
- [ ] Рост усилий без роста результата

Если отмечен любой сигнал:
- Действие в 48 часов: _

### 8) Решение на следующую неделю (1 абзац)
_
