...
Источник сценария: /mnt/c/Users/admin/IWE/PACK-digital-platform/pack/digital-platform/02-domain-entities/DP.ROLE.012-strategist/scenarios/scheduled/note-review.md
...
- Сверь заметку с коммитами за сегодня (`git log --since="00:00" --all --oneline` по всем /mnt/c/Users/admin/IWE/ репо) и текущим WeekPlan
