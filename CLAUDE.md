...
Рабочая директория: `/mnt/c/Users/admin/IWE/` (не из sub-директорий). `/mnt/c/Users/admin/IWE/memory/` = симлинк на auto-memory.
...
- `/mnt/c/Users/admin/IWE/` — рабочая директория
...
### Always-on instruction preservation

- Каноническая авторская инструкция режима работы агента хранится в `extensions/iwe-work-culture.md`.
- Её встраивание в протоколы хранится в:
  - `extensions/protocol-open.after.iwe-work-culture.md`
  - `extensions/day-open.before.iwe-work-culture.md`
  - `extensions/protocol-close.checks.iwe-work-culture.md`
  - `extensions/day-close.after.iwe-work-culture.md`
  - `extensions/week-close.after.iwe-work-culture.md`
- Если после обновления отсутствует или сброшено `.cursor/rules/iwe-work-culture-execution.mdc`, его нужно восстановить как thin-wrapper поверх `extensions/iwe-work-culture.md`, а не перепридумывать инструкцию заново.
- При анализе совместимости обновления всегда проверять сохранность этих файлов как обязательной авторской кастомизации.


### No Auto-Create Rule (БЛОКИРУЮЩЕЕ для агентов)

**Новые папки, репозитории, системы → НЕ создаются без явного разрешения пользователя.**
- Примеры: DS-exocortex, DS-agent-workspace (если инициализировано), новые инструменты, шаблоны.
- Если нужно создать: спросить пользователя → получить согласие → создать.
- Ошибка: удалить и зафиксировать решение в git-коммите.
...
*Версия платформы: v0.22.0 (HEAD 81ef0bf)*
*Дополнение (No Auto-Create Rule): 2026-04-03*
