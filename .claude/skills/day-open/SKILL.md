...
Коммиты за вчера по всем `/mnt/c/Users/admin/IWE/*/` репо. Сопоставить с DayPlan.
...
**Проверка обновлений:** `cd /mnt/c/Users/admin/IWE/FMT-exocortex-template && bash update.sh --check 2>&1`. Если доступно обновление → добавить в «Требует внимания»: «Доступно обновление IWE → `/iwe-update`».
