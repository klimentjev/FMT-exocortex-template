# PACK — доменные Pack'и в workspace

Здесь лежат **локальные** предметные Pack'и (паспорта областей знания), не путать с внешними репозиториями вроде `PACK-digital-platform` на GitHub.

| Папка | Домен (кратко) |
|-------|----------------|
| `PACK-aufheben/` | Процедура снятия, ЭП, три момента |
