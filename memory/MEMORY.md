...
> W32 закрыта **20.08**. Факты: S1-RP1 done 20.08 (печать) · АнтиСофист done 20.08 (проведён) · РП-405 done 21.08 (отчёт о здоровье) · фитнес skip (простуда).

| # | РП | Бюджет | Статус | Дедлайн |
|---|-----|--------|--------|---------|
| W34-review | Орг — Open/Close до вс | 1h | in_progress · восстановление 20.08 | 2026-08-23 |
| НЭП-2 | Деньги — касание/причина после 14:00 | 1–2h | pending · 20.08 skip как долг · стоп-отчет подписок **08.09** | авг ≥100 тыс. |
