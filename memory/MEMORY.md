...
4. **Отчёты:** ВСЕ репо в /c/Users/admin/IWE
/
5. **Процессы:** Нельзя реализовывать без PROCESSES.md (CLAUDE.md § 3)

---

## РП текущей недели (W16: 13–19 апр)
...
| 2 | Блог М. Тяжевой — написать пост | 1h | done | — |
| 3 | РП 6 / Диссертация (R2) — доклад как фрагмент | 5.5h | in_progress | 18.04 *(финал доклада в `DS-strategy/drafts/philosophy-as-logic-of-aufhebung-final.md`, 15.04)* |
| 4 | Эпохальный курс — запуск блока «Аристотель» | ~2h | pending | 22.04 |
