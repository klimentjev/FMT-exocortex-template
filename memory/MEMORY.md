...
|---|-----|--------|--------|---------|
| S1-RP1 | Диссертация — фрагмент show-ready | 12h | pending (пн 1.5h/365 зн.; вт 0h; ср 1.5h/299 зн. + прозрение; чт+пт 0h; неделя ~3h/12) | W31 |
| НЭП-2 | Деньги — ≥3 касания + правило 10:00 | 5h | pending (пн НИФ; вт пост МТ; ср skip recovery; чт skip без протокола; **пт skip по recovery**; счётчик **2/3** — неделя без 3-го) | W31 |
| АнтиСофист | Бумажная версия к 10.08, партия 15.08 | горизонт | pending (W32–W33; чт+пт skip) | 2026-08-10 |

> Done в W31: WP-8 (ср+чт) · Health 2/2 · **W31-review Close 5/5** пн–пт. Пт: быт 4h + Cascade/Strategy «твёрдый след»; приоритеты 0.
