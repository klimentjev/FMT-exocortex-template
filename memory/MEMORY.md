...
|---|-----|--------|--------|---------|
| S1-RP1 | Диссертация — фрагмент show-ready | 12h | pending (пн 1.5h/365 зн.; вт 0h; ср 1.5h/299 зн. + прозрение форма метода ≠ форма предмета) | W31 |
| НЭП-2 | Деньги — ≥3 касания + правило 10:00 | 5h | pending (пн НИФ; вт пост МТ; ср skip recovery — удар в паре; счётчик 2/3) | W31 |
| АнтиСофист | Бумажная версия к 10.08, партия 15.08 | горизонт | pending (ср: дедлайны вписаны в планы; слоты W31 хвост + W32–W33) | 2026-08-10 |
| W31-review | Орг-управление — Close с фактом | 2h | pending (пн–ср ✓ · 3/5) | вс W31 |

> Done в W31 (29.07): WP-8 сильный прогресс (ядро v2 + идеи-сырьё + презентация v2 + PNG-серии) · Health 2/2 (ЖИМ пн + ТЯГА ср, журнал).
