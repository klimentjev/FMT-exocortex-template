...
- **Governance-синхронизация:** новые репо или сервисы за день? → проверить: (1) `DS-ecosystem-development/0.OPS/REPOSITORY-REGISTRY.md` — быстрый тест: `ls -1d /mnt/c/Users/admin/IWE/*/ | wc -l` vs записей в реестре; (2) `memory/navigation.md` — новые пути; (3) если коммиты в PROCESSES.md → сверить с MAP.002. Расхождение → пометить в задел на завтра
